...
public class MenuBuilder {
  public static void main(String[] args) {
    ...
    // Create a variable called menu of type ArrayList to store MenuItem objects.
    ...
    MenuItem mainCourse = new MenuItem("Pulav");
    ...
    MenuItem dessert = new MenuItem("Gelly Dessert");
